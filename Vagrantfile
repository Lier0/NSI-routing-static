...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "ubuntu-static1" do |node1|
    node1.vm.hostname = "ubuntu-static1"
  ...
  config.vm.define "ubuntu-static2" do |node2|
    node2.vm.hostname = "ubuntu-static2"
  ...
  config.vm.define "ubuntu-static3" do |node2|
    node2.vm.hostname = "ubuntu-static3"
