...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "ubuntu-static1" do |node|
    node.vm.hostname = "ubuntu-static1"
  ...
  config.vm.define "ubuntu-static2" do |node|
    node.vm.hostname = "ubuntu-static2"
  ...
  config.vm.define "ubuntu-static3" do |node|
    node.vm.hostname = "ubuntu-static3"
  ...
  config.vm.define "ubuntu-static4" do |node|
    node.vm.hostname = "ubuntu-static4"
